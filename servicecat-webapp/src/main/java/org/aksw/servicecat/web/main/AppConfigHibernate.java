...
@Configuration
@PropertySource("classpath:config/jdbc/hibernate.properties")
@ComponentScan("org.aksw.servicecat.model")
...
{		
	...
	*/
    ...
    public FactoryBean<EntityManagerFactory> entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("org.aksw.servicecat.model");
...
//        properties.setProperty("hibernate.generate_statistics", "true");
		...
		throws Exception
	{
		...
		InputStream in = this.getClass().getResourceAsStream("/servicecat.sml");
