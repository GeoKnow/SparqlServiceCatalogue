...
public class MainServiceCatServer {
	...
	private static final Logger logger = LoggerFactory.getLogger(MainServiceCatServer.class);
...
//	    Object o = engine.eval("println('Hello, ' + name); var foo = {yay: 1}; var bar = JSON.stringify(foo);");
...
//		Integer port = SparqlifyCliHelper.parseInt(commandLine, "P", false, loggerCount);
		...
		ProtectionDomain protectionDomain = MainServiceCatServer.class.getProtectionDomain();
